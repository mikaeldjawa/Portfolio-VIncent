      ...
      <div className='px-5 py-8 md:p-8 bg-white dark:bg-nightBlack rounded-2xl about-section lg:p-10 2xl:p-13'>
        ...
        <div className='mt-7 md:mt-10 section-title'>
          ...
          <p className='max-w-2xl mt-4 md:mt-6 subtitle'>
            Hi, my name is{" "}
            <span className='text-black dark:text-white'>Vincent Wijaya</span> .
            As a Developer and IT Business Analyst, I have hands-on experience
            in designing reconciliation systems and automating financial
            processes in the banking sector. I have a proven ability to bridge
            business needs and technical solutions through Agile collaboration,
            full-stack development, and clear documentation.
          </p>
        </div>
